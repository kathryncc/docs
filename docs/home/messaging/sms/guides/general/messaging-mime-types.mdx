...
The overall size limit is 1MB for local numbers and 750KB for toll-free numbers. Most carriers support message attachments with a total size of 1MB. However, to maximize deliverability across all carriers, limit your attachment size to 500KB. 
